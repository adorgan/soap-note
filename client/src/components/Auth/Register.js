...
export default function Register() {
  ...
  useEffect(() => {
    if (userExists) {
      document.getElementById("registration-error-email").style.visibility =
        "visible";
    } else {
      document.getElementById("registration-error-email").style.visibility =
        "hidden";
  ...
  useEffect(() => {
    if (captchaFail) {
      document.getElementById("registration-error-captcha").style.visibility =
        "visible";
    } else {
      document.getElementById("registration-error-captcha").style.visibility =
        "hidden";
    ...
    <>
      ...
      <div className="register-content-container">
        ...
        >
          ...
          <div id="registration-error-email" className="registration-error">
            User already exists!
          </div>
          <div className="registration-div">
          ...
          <div id="registration-error-password" className="registration-error">
          ...
          <ReCAPTCHA
            ...
            ref={recaptchaRef}
          />
          <div id="registration-error-captcha" className="registration-error">
