const makeToiletTransfer = (
    ...
    to maximize success. The therapist guided the resident to also use a ${toilet_transfer_adaptive_equipment} to further assist.
    The therapist provided ${toilet_transfer_fim} and ${toilet_transfer_verbal_cueing} for the resident
    to complete ${toilet_transfer_tasks} transfers using a ${toilet_transfer_aids}.`;
